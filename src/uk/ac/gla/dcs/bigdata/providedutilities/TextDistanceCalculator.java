...
/**
 * Calculates the distance between two strings using LevenshteinDistance normalised into a 0-1 range. 
 * Higher values indicate the strings are more dissimilar.
 * @author Richard
 *
 */
public class TextDistanceCalculator {
	...
	/**
	 * Calculate the normalised distance between two strings. 
	 * Outputs a value between 0 and 1, where higher values indicate the texts are more dissimilar
